...
function showBoxesElements () {
    elements = [
        // Small Box
        ['<br><img id="pfp" class="fadein" src="images/pfp.png">','#sml-sub1'],
        ...
        ['<a href="mailto:hamadanime1@gmail.com" ><img class="simg" src="images/email.png"></a><br>','#social'],
        ['<a href="https://github.com/mohdmot" ><img class="simg" src="images/github.png"></a><br>','#social'],
        ['<a href="https://www.instagram.com/z1.2d" ><img class="simg" src="images/insta.png"></a><br>','#social'],
        ['<a href="https://t.me/aaambd1" ><img class="simg" src="images/tele.png"></a><br>','#social'],
        ['<a href="https://twitter.com/mhmd_albkry" ><img class="simg" src="images/x.png"></a><br><br>','#social'],
        ...
        ['<img class="fadein plimg" src="images/py.png">&ensp;<img class="fadein plimg" src="images/c.png">&ensp;<img class="fadein plimg" src="images/php.png">&ensp;<img class="fadein plimg" src="images/js.png">&ensp;<img class="fadein plimg" src="images/html.png">&ensp;<img class="fadein plimg" src="images/css.png">&ensp;','#big-sub1 > div:nth-child(1)'],
        ...
        ['<a href="https://drive.google.com/drive/folders/1_4FThWfGL0pwjaDF6vBpAvNq6ylyU-BI?usp=sharing"></a>','#big-sub1 > div:nth-child(1)'],
        ['autotype:My Google Drive','#big-sub1 > div:nth-child(1) > a:nth-child(13)'],
        ['<h2></h2><p></p>','#big-sub1 > div:nth-child(1)'],
        ['autotype:> Some of my Projects','#big-sub1 > div:nth-child(1) > h2:nth-child(14)'],
        ['autotype:I have some good projects currently, I am always working on increasing them.','#big-sub1 > div:nth-child(1) > p:nth-child(15)'],
        ['<table> <tr> <td></td><td></td> </tr> <tr> <td></td><td></td> </tr> </table>','#big-sub1 > div:nth-child(1)'],
        ['<a href="https://github.com/mohdmot/webwareos" ><img class="fadein pimg" src="https://raw.githubusercontent.com/mohdmot/webwareos/main/src/img/logo.png">', '#big-sub1 > div:nth-child(1) > table:nth-child(16) > tbody:nth-child(1) > tr:nth-child(1) > td:nth-child(1)'],
        ['<a href="https://github.com/mohdmot/FxLinux" ><img class="fadein pimg" src="https://raw.githubusercontent.com/mohdmot/FxLinux/main/logo.png">', '#big-sub1 > div:nth-child(1) > table:nth-child(16) > tbody:nth-child(1) > tr:nth-child(1) > td:nth-child(2)'],
        ['<a href="https://www.kagsa.org/" ><img class="fadein pimg" src="https://camo.githubusercontent.com/9181b65a342edb8b24a1a6bc5015c2279d2da763f5e876fc222bece8618cc299/68747470733a2f2f7777772e6b616773612e6f72672f646f776e6c6f61642f6173736574732f6c6f676f2e706e67">', '#big-sub1 > div:nth-child(1) > table:nth-child(16) > tbody:nth-child(1) > tr:nth-child(2) > td:nth-child(1)'],
        ['<a href="https://github.com/mohdmot/CustomClassifier" ><img class="fadein pimg" src="https://github.com/mohdmot/CustomClassifier/blob/main/logo.png?raw=true">', '#big-sub1 > div:nth-child(1) > table:nth-child(16) > tbody:nth-child(1) > tr:nth-child(2) > td:nth-child(2)'],
        ['<p></p><br>','#big-sub1 > div:nth-child(1)'],
        ['autotype:Visit my Github for more content.','#big-sub1 > div:nth-child(1) > p:nth-child(17)'],
    ]
