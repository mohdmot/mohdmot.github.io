...
function showBoxesElements () {
    ...
    elements = [
        ...
        ['<a href="https://www.kagsa.org/" ><img class="fadein pimg" src="https://www.kagsa.org/download/assets/logo.png">', '#big-sub1 > div:nth-child(1) > table:nth-child(15) > tbody:nth-child(1) > tr:nth-child(2) > td:nth-child(1)'],
